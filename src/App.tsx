...
import { useAppContext, useThemeCtx } from './context/provider';
...
// Components
import { Sidebar, Navbar, Theme } from './components';

function App() {
  const { activeMenu } = useAppContext();
  const { themeSettings, setThemeSettings, currentColor, mode } = useThemeCtx();
  ...
  return (
    <div className={mode === 'Dark' ? 'dark' : undefined}>
      <div className='flex relative dark:bg-main-dark-bg'>
        ...
        <div
          className={
            activeMenu ? 'routeHeader md:ml-72 ' : 'routeHeader flex-2'
          }>
